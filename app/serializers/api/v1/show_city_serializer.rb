class Api::V1::ShowCitySerializer < ActiveModel::Serializer
  ...
  def city_scores_arrayed
    [object[:nomad_score:]*100, object[:life_score]*100, object[:free_wifi_available]*100, object[:peace_score]*100, object[:fragile_states_index], object[:freedom_score]*100, object[:press_freedom_index], object[:nightlife]*100, object[:leisure]*100, object[:places_to_work]*100, object[:safety]*100, object[:friendly_to_foreigners]*100, object[:racism]*100, object[:lgbt_friendly]*100, object[:female_friendly]*100]
  end

  def names_arrayed
    ["Nomad Score", "Life Score", "Free Wifi Available", "Peace Score", "Fragile States Index", "Freedom Score", "Press Freedom Index", "Nightlife", "Leisre", "Places to Work", "Safety", "Friendly to Foreigners", "Racism", "LGBT Friendly", "Female Friendly"]
  end
end
