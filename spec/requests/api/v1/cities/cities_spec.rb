...
feature "CitiesSerializer", type: :request do
  describe "it only allows the json for the params it gets passed" do
    ...
    it "it always allows all the attributes" do
      ...
      get "/api/v1/cities?country_id&name&url&slug&nomad_score&life_score&free_wifi_available&peace_score&fragile_states_index&freedom_score&press_freedom_index&nightlife&leisure&places_to_work&air_con&safety&friendly_to_foreigners&racism&lgbt_friendly&female_friendly&air_bnb_median_us&cost_as_nomad_us&cost_longterm_us&cost_shortterm_us&air_bnb_vs_appartment_price_ratio"
